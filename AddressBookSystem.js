 ...
 */
 ...
 /**
  * editcontact used to edit the already inserted contact using contact first name
  * @param {*} firstName 
  */
 ...
 /**
  * if user choosed search by city or state 
  * by enter contact city or state user can search the contact in addressbook
  * @param {*} searchCityOrState 
  * @param {*} choice 
  */
 ...
 /**
  * counting contacts by city or state
  * @param {*} countCityOrState 
  * @param {*} choice 
  */
